...
http_proxy = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'
https_proxy = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'
no_proxy = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'
...
#file2 = open(""+dirpath+"databricks_running_job_details.txt", 'w')
file2 = open(""+dirpath+"dbrk_run_job_details.csv", 'w')
print(f"Workspace_Name,Job_ID,Job_Name,Last_Run_Time,Databricks_URL", file=file2)
...
#                               "Databricks_URL": databricks_url[0]
                            ...
                            for job in job_details:
                                ...
                                if job["last_run_time"] is None:
                                    ...
                                    last_run_time = convert_timestamp(job["last_run_time"])
                                print(f"{databricks_url[1]}, {job_id}, {job_name}, {last_run_time}, {databricks_url[0]}", file=file2)
...
#    with open(""+dirpath+"dbrk_header_run_job_details.csv", 'r') as file:
    with open(""+dirpath+"dbrk_run_job_details.csv", 'r') as file:
    ...
    with open(""+dirpath+"dbrk_final_sort_run_job_info_"+todate+".csv", 'w') as file:
...
def main():
    ...
    sort_unique_file() ##Need to check this function as if there are no unique lines, file is empty
    print(f"If "+dirpath+"dbrk_final_sort_run_job_info_"+todate+".csv file is empty, then check data in "+dirpath+"dbrk_run_job_details.csv")
